...
}                                               //An interrupt to detect the button press and to clear the interrupt OF THE Pin.

void UART_INT(void)
{
    character= UART_GetChar();
    isr_UART_ClearPending();
}                                               //An interrupt to detect the character and to clear the interrupt in the UART.
...
}                                               //An interrupt to clear the interrupt of ADC.
