// ======================================================================
// First.v generated from TopDesign.cysch
// 07/04/2021 at 23:08
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("a4848a30-1291-4ab6-a902-fc7d4501c0c8/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("a4848a30-1291-4ab6-a902-fc7d4501c0c8/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module WaveDAC8_v2_10_4 (
	...
	cy_clock_v1_0
		#(.id("4afcf915-0d8a-4f55-ab8e-af66d646610b/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__PinRed_net;
	wire [0:0] tmpFB_0__PinRed_net;
	wire [0:0] tmpIO_0__PinRed_net;
	wire [0:0] tmpINTERRUPT_0__PinRed_net;
	electrical [0:0] tmpSIOVREF__PinRed_net;
	...
	cy_psoc3_pins_v1_10
		...
		PinRed
		 (.oe(tmpOE__PinRed_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PinRed_net[0:0]}),
		  .io({tmpIO_0__PinRed_net[0:0]}),
		  .siovref(tmpSIOVREF__PinRed_net),
		  .interrupt({tmpINTERRUPT_0__PinRed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PinRed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PinGreen_net;
	wire [0:0] tmpFB_0__PinGreen_net;
	wire [0:0] tmpIO_0__PinGreen_net;
	wire [0:0] tmpINTERRUPT_0__PinGreen_net;
	electrical [0:0] tmpSIOVREF__PinGreen_net;

	cy_psoc3_pins_v1_10
		#(.id("e172183e-6dbd-4247-9d3c-620f6d1c153f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PinGreen
		 (.oe(tmpOE__PinGreen_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PinGreen_net[0:0]}),
		  .io({tmpIO_0__PinGreen_net[0:0]}),
		  .siovref(tmpSIOVREF__PinGreen_net),
		  .interrupt({tmpINTERRUPT_0__PinGreen_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PinGreen_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PinYellow_net;
	wire [0:0] tmpFB_0__PinYellow_net;
	wire [0:0] tmpIO_0__PinYellow_net;
	wire [0:0] tmpINTERRUPT_0__PinYellow_net;
	electrical [0:0] tmpSIOVREF__PinYellow_net;

	cy_psoc3_pins_v1_10
		#(.id("03e932a6-14ca-4e4a-9adf-3ec171d915f7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PinYellow
		 (.oe(tmpOE__PinYellow_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PinYellow_net[0:0]}),
		  .io({tmpIO_0__PinYellow_net[0:0]}),
		  .siovref(tmpSIOVREF__PinYellow_net),
		  .interrupt({tmpINTERRUPT_0__PinYellow_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PinYellow_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("cea092b2-eb7b-4aa9-af77-36b2b4c3bdc5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_DACout_net;
	wire [0:0] tmpFB_0__Pin_DACout_net;
	wire [0:0] tmpIO_0__Pin_DACout_net;
	wire [0:0] tmpINTERRUPT_0__Pin_DACout_net;
	electrical [0:0] tmpSIOVREF__Pin_DACout_net;

	cy_psoc3_pins_v1_10
		#(.id("bb08cd38-ecac-4536-8a4f-ddbd8206f880"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_DACout
		 (.oe(tmpOE__Pin_DACout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_DACout_net[0:0]}),
		  .analog({Net_51}),
		  .io({tmpIO_0__Pin_DACout_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_DACout_net),
		  .interrupt({tmpINTERRUPT_0__Pin_DACout_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_DACout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_PushButton_net;
	wire [0:0] tmpFB_0__Pin_PushButton_net;
	wire [0:0] tmpIO_0__Pin_PushButton_net;
	electrical [0:0] tmpSIOVREF__Pin_PushButton_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PushButton
		 (.oe(tmpOE__Pin_PushButton_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_PushButton_net[0:0]}),
		  .io({tmpIO_0__Pin_PushButton_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PushButton_net),
		  .interrupt({Net_56}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_PushButton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
